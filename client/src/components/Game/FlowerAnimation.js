...
const FlowerAnimation = () => {
    return (
        ...
        <div style={{ position: 'absolute', overflow: 'hidden', width: '100%', height: '100vh', zIndex: -1 }}>
            {/* 원하는 꽃가루 개수 넣어 헿 */}
            {[...Array(100)].map((_, index) => (
                ...
                <LocalFlorist
                    ...
                    style={{
                        ...
                        color: `rgb(${Math.random() * 255}, ${Math.random() * 255}, ${Math.random() * 255})`, // 꽃가루의 색상은 랜덤하게 설정됩니다.
                    }}
                />
            ))}
