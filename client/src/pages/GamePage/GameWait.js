import { setSession as setRoomSession, setConnection as setUserConnection, setConnectionToken, resetRoomState, setGameseq } from "../../store";
...
function GameWait() {
  ...
  const joinSession = async () => {
    try {
      ...
      newSession.connect(connectionToken, { clientData: myUserName })
        .then(async () => {
        ...
        .catch((error) => {
          console.log('세션을 연결하는데 에러가 존재한다!! :', error.code, error.message);
        });
    } catch (error) {
